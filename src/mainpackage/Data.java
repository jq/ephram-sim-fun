...
//    }
    public ArrayList<Solution> getSolutions() {
        ...
        for (int j = 0; j < replicas.size(); ++j) {
            ...
            {
                sList.add(new Solution(1, replicas.get(j).getRecordAccessTime(), this, false, replicaPriceLinear[j]));
            } else {
                sList.add(new Solution(0, replicas.get(j).getRecordAccessTime(), this, true, replicaPriceLinear[j]));
            }
        }
        return sList;
    }
